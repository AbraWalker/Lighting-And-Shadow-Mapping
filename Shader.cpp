...
ID3D11PixelShader*  gNormalCubePixelShader = nullptr;
ID3D11VertexShader* gNormalCubeVertexShader = nullptr;
ID3D11PixelShader*  gCSOPixelShader = nullptr;
ID3D11VertexShader* gCSOVertexShader = nullptr;
ID3D11PixelShader*  gCSPixelShader = nullptr;
ID3D11VertexShader* gCSVertexShader = nullptr;
...
bool LoadShaders()
{
	...
	gSpherePixelShader			= LoadPixelShader("SpherePixelShader");
	gSphereVertexShader         = LoadVertexShader("SphereVertexShader");
	gParallaxMappingPixelShader = LoadPixelShader("ParallaxMappingPixelShader");
	gParallaxMappingVertexShader = LoadVertexShader("ParallaxMappingVertexShader");
	gCubePixelShader			= LoadPixelShader("CubePixelShader");
	gCubeVertexShader			= LoadVertexShader("CubeVertexShader");
	gNormalCubePixelShader		= LoadPixelShader("NormalMappingPixelShader");
	gNormalCubeVertexShader		= LoadVertexShader("NormalMappingVertexShader");
	gCSOPixelShader = LoadPixelShader("CSOPixelShader");
	gCSOVertexShader = LoadVertexShader("CSOVertexShader");
	gCSPixelShader = LoadPixelShader("CSPixelShader");
	gCSVertexShader = LoadVertexShader("CSVertexShader");



    if (gPixelLightingVertexShader  == nullptr || gPixelLightingPixelShader == nullptr ||
        gBasicTransformVertexShader == nullptr || gLightModelPixelShader    == nullptr || gDepthOnlyPixelShader == nullptr || gSpherePixelShader == nullptr || gSphereVertexShader == nullptr || 
		gParallaxMappingPixelShader == nullptr || gParallaxMappingVertexShader == nullptr || gCubePixelShader == nullptr || gCubeVertexShader == nullptr || gNormalCubePixelShader == nullptr || gNormalCubeVertexShader == nullptr ||
		gCSOPixelShader == nullptr ||gCSOVertexShader == nullptr)
    {
