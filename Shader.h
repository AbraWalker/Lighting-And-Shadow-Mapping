...
extern ID3D11VertexShader* gCubeVertexShader;
extern ID3D11PixelShader* gNormalCubePixelShader;
extern ID3D11VertexShader* gNormalCubeVertexShader;
extern ID3D11PixelShader* gCSOPixelShader;
extern ID3D11VertexShader* gCSOVertexShader;
extern ID3D11PixelShader* gCSPixelShader;
extern ID3D11VertexShader* gCSVertexShader;
