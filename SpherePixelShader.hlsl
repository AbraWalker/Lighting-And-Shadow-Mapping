...
float4 main(LightingPixelShaderInput input) : SV_Target
{
    ...
    float4 textureColour = DiffuseSpecularMap.Sample(TexSampler, input.uv + (gLight1Position.x / 10));
    ...
    return float4(finalColour * 2, 1.0f); // Always use 1.0f for output alpha - no alpha blending in this lab
}